...
const Receipt = () => {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            ...
            // ... (rest of fetch logic assumed same, keeping brevity)
    ...
    const handleWebBluetoothPrint = async () => {
        ...
        try {
            ...
            console.error(err);
            alert("Bluetooth Print Failed: " + err.message + "\\n\\nNote: This only works with BLE printers on Chrome Desktop/Android.");
        }
    };
