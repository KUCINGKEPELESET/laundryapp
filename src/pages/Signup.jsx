    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            if (data.user && !data.session) {
                ...
                // Session active (Email confirm disabled or autoconfirmed)
                navigate('/dashboard');
            }
        } catch (error) {
            alert(error.message);
            ...
            <div className="flex-1 flex flex-col px-5 -mt-6 relative z-10 w-full max-w-md mx-auto">
                    ...
                    <form onSubmit={handleSignup} className="flex flex-col gap-5">
                        ...
                        <div className="group">
                            ...
                            <div className="relative flex items-center transition-transform duration-200 focus-within:scale-[1.01]">
                                <span className="absolute left-4 text-primary/70 material-symbols-outlined select-none" style={{ fontSize: '20px' }}>person</span>
                                <input
                                    type="text"
                                    required
                                    value={fullName}
                        ...
                        <div className="group">
                            ...
                            <div className="relative flex items-center transition-transform duration-200 focus-within:scale-[1.01]">
                                <span className="absolute left-4 text-primary/70 material-symbols-outlined select-none" style={{ fontSize: '20px' }}>call</span>
                                <input
                                    type="tel"
                                    required
                                    value={phone}
                ...
                <div className="flex flex-col gap-6 items-center py-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm">
                        ...
                        <Link to="/login" className="text-primary font-extrabold hover:text-[#005a63] ml-1 transition-colors">Log In</Link>
                    </p>
                </div>
            </div>
        </div>
